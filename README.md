...
3. Grafana dashboard works fine but need to adjust new variables for NODE height.
4. Even if I modified sserver.cfg for mainnet, I think it needs to be adjusted better for CKB
